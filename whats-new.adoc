...
Questa versione offre le nuove funzionalità elencate di seguito. Risolve inoltre i problemi descritti in https://docs.netapp.com/us-en/cloud-manager-file-cache/fixed-issues.html["Problemi risolti"]. I pacchetti software aggiornati sono disponibili all'indirizzo https://docs.netapp.com/us-en/cloud-manager-file-cache/download-gfc-resources.html#download-required-resources["questa pagina"].
...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/concept-licensing.html#packages["Scopri di più sul pacchetto di licenza Edge cache."]
...
Questa versione offre le nuove funzionalità elencate di seguito. Risolve inoltre i problemi descritti in https://docs.netapp.com/us-en/cloud-manager-file-cache/fixed-issues.html["Problemi risolti"].
...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/concept-licensing.html#capacity-based-licensing["Scopri di più sul pacchetto di licenza Edge cache."]
...
Questa versione risolve i problemi descritti in https://docs.netapp.com/us-en/cloud-manager-file-cache/fixed-issues.html["Problemi risolti"].



== 19 maggio 2022 (versione 1.3.0)

Il software Global file cache Edge per la versione 1.3.0 è disponibile all'indirizzo https://docs.netapp.com/us-en/cloud-manager-file-cache/download-gfc-resources.html#download-required-resources["questa pagina"].



=== Nuova funzionalità Metadata Edge Sync

Questa funzione "Metadata Edge Sync" utilizza la funzionalità di sincronizzazione Edge come framework principale. Solo le informazioni sui metadati vengono aggiornate su tutti gli edge sottoscritti e i file/cartelle vengono creati sui computer Edge.



=== Miglioramenti del servizio License Manager

Il servizio Global file cache License Management Server (LMS) è stato migliorato per rilevare automaticamente le impostazioni proxy. Ciò consente una configurazione perfetta.
