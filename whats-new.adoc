...
Sebbene annunciamo la fine del ciclo di vita di questi prodotti, NetApp continuerà a supportarli fino al 31 maggio 2027. https://mysupport.netapp.com/info/communications/CPC-00578.html["Vedi i dettagli della fine della disponibilità di Global file cache di NetApp"^].
